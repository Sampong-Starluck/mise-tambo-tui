...
public class MiseMaintenanceServiceImp implements MiseMaintenanceService {
    ...
    @Override
    public CliResult doctor(@NonNull Consumer<String> onLine) {
        return cli.runStreaming(List.of("doctor"), Duration.ofSeconds(30), onLine);
    }

    @Override
    public CliResult selfUpdate(@NonNull Consumer<String> onLine) {
    ...
    @Override
    public CliResult prune(@NonNull Consumer<String> onLine) {
